...
const HospitalServicesDetails = () => {
  ...
  useEffect(() => setBreadcrumbs(service?.name), [setBreadcrumbs, service]);
    ...
    <div>
      {
        !isLoading ?
          <>
                ...
                <div className="dropdown dropdown-end">
                  <div tabIndex={0} className="form-control">
                    <label className="input-group input-group-sm">
                      <input type="text" defaultValue={formatedDate} readOnly className="input input-bordered !input-sm hidden md:inline-block" />
                      <span className='h-8'><SlCalender></SlCalender></span>
                    </label>
                  </div>
            ...
            <div className='text-center text-sm text-accent mb-5 block md:hidden'><p>Slots showing for {format(selectedDate, 'PP')}.</p></div>
          ...
          <>
            ...
            <Skeleton width={130} />
            <Skeleton width={100} className='mb-16' />

            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
              <Skeleton count={10} height={23} />
              <Skeleton count={10} height={23} />
            </div>
          </>
      }
